  ...
  return (
    <>
      ...
      <div className="flex-1">
        <Grow appear={true} in={true} {...(true ? { timeout: 500 } : {})}>
          <Box className="cbox">
            <div
              style={{
                marginTop: "30px",
            ...
            >
              <div className="break-words">
                ...
                <div className="w-full text-center lg:text-left px-10 lg:px-5 lg:w-4/5 text-4xl lg:text-6xl font-jd_code lg:p-5 bg-[#00000048] lg:bg-transparent rounded-3xl">
                  ...
                  passionate, dedicated and diligent. Looking to use my coding
                  and programming skills as efficiently as possible. I
                  consistently look for an opportunity to hone my skills.
                </div>
              </div>
            </div>
          </Box>
